...
const RelatedCards = ( props ) => {
  ...
  React.useEffect(()=> {
    Axios.get(`https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfp/products/${globalProductID}/related`, { headers: { "Authorization": `${TOKEN}` } })
    .then( (res) => {
  ...
  return (
    <div>
      <p></p>
      Click Any name/id below to change the ProductIDContext
